...
- `git clone https://github.com/UniversalPropositions/UP_Ukrainian-IU.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Ukrainian-IU>/ --input_up=<up_path_to_UP_Ukrainian-IU>/ --output=<path_to_UD+UP_Ukrainian-IU>/`
